...
public class Payment implements Serializable {
    ...
    public void setPaymentTypes(Set<PaymentType> paymentTypes) {
        if (this.paymentTypes != null) {
            this.paymentTypes.forEach(i -> i.setPayment(null));
        }
        if (paymentTypes != null) {
            paymentTypes.forEach(i -> i.setPayment(this));
        }
        this.paymentTypes = paymentTypes;
    }

    public Payment paymentTypes(Set<PaymentType> paymentTypes) {
        this.setPaymentTypes(paymentTypes);
        return this;
    }

    public Payment addPaymentType(PaymentType paymentType) {
        this.paymentTypes.add(paymentType);
        paymentType.setPayment(this);
        return this;
    }

    public Payment removePaymentType(PaymentType paymentType) {
