...
public class Reservation implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "reservation", "paymentDetails" }, allowSetters = true)
    ...
    public void setServiceInfo(ServiceInfo serviceInfo) {
        if (this.serviceInfo != null) {
            this.serviceInfo.setReservation(null);
        }
        if (serviceInfo != null) {
            serviceInfo.setReservation(this);
        }
        this.serviceInfo = serviceInfo;
    }

    public Reservation serviceInfo(ServiceInfo serviceInfo) {
